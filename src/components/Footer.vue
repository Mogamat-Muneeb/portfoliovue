...
.social1-menu ul li .fab:hover{
    color: #fff;
}
.social1-menu ul li .fa:hover{
    color: #fff;
}

.social1-menu ul li a{
    position: relative;
    display: block;
    width: 47px;
    height: 47px;
...
.social1-menu ul li a:hover{
    transform: translate(0, -10%);
}

.social1-menu ul li:nth-child(1) a:hover{
